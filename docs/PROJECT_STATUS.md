...
|---|-------------|--------|-------|
| 1 | VPS credentials from client | Not yet needed | Required for Phase 4 deployment |
| 2 | Domain name for production | Not yet needed | Required for Phase 4 deployment |
| 3 | DS Properties logo | Not yet needed | Using "DSP" placeholder until provided |
| 4 | Historical data for migration | Not yet discussed | CSV import utility planned but not in Phase 1 tasks |
...
> 3. Read `DECISIONS.md` for architectural decisions already made
...
> 6. Reference `PROJECT_MASTER_PLAN.md` for folder structure and technology stack
>
